document.addEventListener('DOMContentLoaded', () => {
    ...
    const links = [
        { text: 'Alumni Database', url: 'https://kanyadet-school-admin.web.app/New-Students-Database/Alumni-database.html' },
        { text: 'Edit Biodata', url: 'https://kanyadet-school-admin.web.app/New-Students-Database/Missing-Fields/All-missing-Fields/Alumni.html' },
