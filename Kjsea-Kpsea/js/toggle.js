...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const links = [
        { text: '👨‍⚕️Kjsea Admin', url: 'https://kanyadet-school-admin.web.app/Kjsea-Kpsea/Admin-Kjsea-Results.html' },
        { text: '👨‍⚕️Kpsea Admin', url: 'https://kanyadet-school-admin.web.app/Kjsea-Kpsea/Admin-Kpsea-Results.html' },
    ...
    const buildModal = () => {
      ...
      <i class='bx bxs-book'></i>
                ...
                <h2 style="font-size: 34px; font-weight: bold; color: #1f2937; text-align: center;">National Results Configurations Dashboard</h2>
