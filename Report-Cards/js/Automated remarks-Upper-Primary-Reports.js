...
const REPORT_CARD_CONFIG = {
    subjects: ['Mathematics', 'English', 'Kiswahili', 'Integrated Science', 'Creative Arts & Social studies'],
    gradeScale: [
        { min: 90, max: 99, grade: '8.0', comment: 'Exceeding Expectation EE1' },
        ...
        { min: 21, max: 30, grade: '3.0', comment: 'Approaching Expectation AE1' },
        { min: 11, max: 20, grade: '2.0', comment: 'Approaching Expectation BE1' },
    ...
    ranges: [
        { 
            ...
            remarks: [
                ...
                "Exceptional learner! Demonstrates creativity and innovation in all learning areas. Well done!",
                "Excellent achievement! Shows mastery of competencies and applies learning effectively. Continue to excel.",
                "Outstanding! Demonstrates strong communication and collaboration skills. A pleasure to teach.",
                "Superb performance! Shows excellent self-efficacy and learning to learn skills. Keep soaring higher!"
            ]
        },
        { 
            min: 75, 
            ...
            remarks: [
                ...
                "Well done! Demonstrates good collaboration and communication skills. Continue working hard.",
                "Good progress! Shows developing competencies in problem-solving. Keep practicing and improving.",
                "Strong performance! Demonstrates good citizenship values. Continue to be a positive influence.",
                "Very good work! Shows creativity in learning activities. Keep developing your talents."
            ]
        },
        { 
            min: 58, 
            ...
            remarks: [
                ...
                "Well done on your effort! You're on the right track. Let's focus on applying concepts more consistently.",
                "Solid progress! Your understanding is growing. Regular practice will help deepen your mastery.",
                "Good work! You're developing important skills. Let's work together to build even more confidence.",
                "Encouraging progress! You show promise. With continued effort and support, you'll achieve great things."
            ]
        },
        { 
            min: 41, 
            ...
            remarks: [
                ...
                "You have ability! Together we'll develop your skills. Regular practice and asking questions will help you grow.",
                "You're capable of more! Let's create a support plan to help you master key concepts. I'm here to help.",
                "Progress is happening! With consistent effort and our support, you'll achieve better results. Keep trying!",
                "You're learning! Let's work on building stronger foundations. Extra practice sessions will boost your confidence."
            ]
        },
        { 
            min: 31, 
            ...
            remarks: [
                ...
                "You can grow! Let's create a personalized support plan. With our help and your effort, progress is possible.",
                "Your success matters! We'll provide extra assistance and work closely with your family. You're not alone in this journey.",
                "We're committed to your growth! Catch-up programs and one-on-one support will help build your skills. Keep showing up!",
                "You deserve support! Let's develop a tailored learning plan together. With consistent practice and help, you'll improve."
            ]
        },
        { 
            min: 0, 
            ...
            remarks: [
                ...
                "Every learner can progress! Let's work with the learning support team to create the right environment for your success.",
                "We care about your journey! Together with specialists, we'll develop a personalized approach to build your confidence and skills.",
                "You deserve the best support! Let's meet with your family and our learning team to ensure you have all the help you need.",
                "Your growth is our priority! We're arranging comprehensive support with daily encouragement to help you develop at your own pace."
            ]
        }
    ]
};
...
function extractGrade(gradeString) {
  ...
  async function loadStudentImage(studentName, grade) {
    ...
    doc.setFont(undefined, 'bold');
    doc.setFontSize(9);
    doc.text('CLOSING DATE:FRI 24-2025| OPENING DATE: Mon 01-2026', 100, yPos);
...
function extractGrade(gradeString) {
    ...
    return new Promise((resolve) => {
        ...
        for (let i = 0; i < studentsToProcess.length; i++) {
            ...
            combinedDoc.setFont(undefined, 'bold');
            combinedDoc.setFontSize(9);
            combinedDoc.text('CLOSING DATE:FRI 24-2025| OPENING DATE: Mon 01-2026', 100, yPos);
...
async function exportMissingDataToPdf() {
    ...
    const body = dataToExport.map((student, index) => {
        const row = [
            ...
            String(student['English'] || 'N/A'),
            String(student['Kiswahili'] || 'N/A'),
            String(student['Integrated Science'] || 'N/A'),
            String(student['Creative Arts & Social studies'] || 'N/A'),
            String(student['Total Marks'] || 'N/A'),
            String(student['Perc Avrg'] || 'N/A'),
