document.addEventListener('DOMContentLoaded', () => {
    ...
    const links = [
        { text: 'Active students', url: './Active-Students-Database.html' },
        { text: 'Deleted Students', url: './All-Deleted-Students.html' },
        { text: 'Birth Certifiates', url: './Birth-certificates.html' },
        { text: 'Missing Records', url: 'https://kanyadet-school-admin.web.app/New-Students-Database/Missing-Fields/index.html' },
