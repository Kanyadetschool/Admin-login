document.addEventListener('DOMContentLoaded', () => {
    ...
    const links = [
        ...
        { text: 'students Results', url: 'https://kanyadet-school-admin.web.app/Print-Individual-Results/Results.html' },
        { text: 'Print Reports', url: 'https://kanyadet-school-admin.web.app/Print-Individual-Results/Print-Report.html' },
        { text: 'Deleted Results', url: 'https://kanyadet-school-admin.web.app/Print-Individual-Results/DeletedResults.html' },
        ...
        { text: 'Birth Certificates', url: 'https://kanyadet-school-admin.web.app/New-Students-Database/Birth-certificates.html' },
