/**
 * Junior School Automated Remarks and Report Card Generator
...
// Teacher remarks configuration based on average score
    ...
    ranges: [
        { 
            ...
            remarks: [
                ...
                "Exemplary performance. Well done!",
                "Superb effort and dedication. Keep excelling!"
            ]
        },
        { 
            min: 75, 
        ...
        { 
            ...
            remarks: [
                ...
                "Good attempt. Work on your weaker subjects.",
                "Steady progress. Put in more effort next term."
            ]
        },
        { 
            min: 41, 
            ...
            remarks: [
                ...
                "Average performance. Work harder next term.",
                "Can do better with consistent effort and practice."
            ]
        },
        { 
            min: 31, 
            ...
            remarks: [
                ...
                "Poor performance. Immediate intervention needed.",
                "Unsatisfactory. Must put in more effort and seek help."
            ]
        },
        { 
            min: 0, 
            ...
            remarks: [
                ...
                "Unacceptable performance. Needs intensive support immediately.",
                "Requires urgent intervention. Parent involvement essential."
            ]
        }
    ]
};
  ...
  async function loadStudentImage(studentName, grade) {
    return new Promise((resolve) => {
        ...
        img.onerror = () => {
            ...
            defaultImg.src = './student_images/default.jpg';
...
async function generateBulkReportCards() {
    ...
    try {
        ...
        for (let i = 0; i < studentsToProcess.length; i++) {
            ...
            // Summary section
            yPos = combinedDoc.lastAutoTable.finalY + 2;
